...
uses
  {$IFDEF FPC}
    LResources, LMessages, LCLIntf, LCLType, // used in SetGradientColor
...
type
  ...
  protected
    ...
    FCaption: TCaption;
    FCaptionFont: TFont;
    Procedure CHHitTest(var Message:TLMessage) message CM_HITTEST;
...
begin
  ...
  ImgIcon.OnMouseDown := ImgIconMouseDown;
...
procedure TTitleBar.CHHitTest(var Message: TLMessage);
begin
  if Dragging then
     Message.lParam:=LM_NCHITTEST;
end;
