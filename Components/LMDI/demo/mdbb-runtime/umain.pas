...
begin
  ...
  TB.OnClickClose := TBClickClose;
  TB.OnClickHelp := TBClickHelp;
  TB.OnClickMaximize := TBClickMaximize;
  TB.OnClickMinimize := TBClickMinimize;
  TB.OnClickRestore := TBClickRestore;

  // This not work very nice in Delphi!
  TB.OnDblClick := FormDblClick;
  TB.OnMouseDown := FormMouseDown;
  TB.OnMouseMove := FormMouseMove;
  TB.OnMouseUp := FormMouseUp;
end;
