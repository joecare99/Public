...
type
  ...
  protected
    ...
    property Changed: boolean read FChanged write SetChanged; deprecated 'Is double Identifyer, will be renamed';
  public
...
procedure TConfigViewer.SetChanged(AValue: boolean);
begin
