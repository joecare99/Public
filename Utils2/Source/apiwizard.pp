...
uses
  ...
  Graphics, Dialogs, StdCtrls, Buttons, ExtCtrls, LCLproc, ComCtrls, Menus;
...
type
  ...
  TApiWizForm = class(TForm)
    ...
    txtLazarus: TEdit;
    lblLazarus: TLabel;
    procedure cbgLCLPlatformClick(Sender: TObject);
...
procedure TApiWizForm.cbgLCLPlatformClick(Sender: TObject);
begin
