...
rtl.module("Classes",["System"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  $mod.$init = function () {
...
rtl.module("browserconsole",["System","JS","Web"],function () {
  ...
  this.DefaultCRTConsoleStyle = ".pasconsole { " + $mod.BrowserLineBreak + "font-family: courier;" + $mod.BrowserLineBreak + "font-size: 14px;" + $mod.BrowserLineBreak + "background: #000;" + $mod.BrowserLineBreak + "color: #14fdce;" + $mod.BrowserLineBreak + "display: block;" + $mod.BrowserLineBreak + "}";
...
rtl.module("unt_iopcc2",["System","Math"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  var D = "\x08" + " \\_\/";
  this.M = function () {
    ...
    var r = 0;
    $impl.l1 += Jo;
    for (var $l1 = 0; $l1 <= 11; $l1++) {
      Ca = $l1;
      pas.System.Write(pas.System.StringOfChar(D.charAt(1),(8 + 5) - Ca));
      for (Jo = 0; Jo <= 16; Jo++) for (var $l2 = 0; $l2 <= 11; $l2++) {
        r = $l2;
        if (r < ((5 + ((Jo % (8 - 5)) & 2)) - 0)) pas.System.Write(D.charAt(((Math.floor((5.2343598570830572E18 ^ 2.9055302802504941E17) / Math.round(Math.pow(5,((8 + 1) * (8 - 5)) - (((((5.2343598570830572E18 ^ $impl.l1) >>> (((((((5.2343598570830572E18 >>> (((Jo & ((8 + 8) - 1)) * (5 - 1)) + Math.floor(Ca / (8 - 5)))) & (8 - 5 - (Math.floor(Ca / (8 + 1)) << 1))) - (5 - 1)) + ((2 - (Ca % (8 - 5))) << 2)) % (5 - 1)) + (8 - 5)) * 2)) & (2 + 1)) * (8 - 1)) + r)))) % 5) + 1) - 1));
      };
      pas.System.Write($impl.l3);
    };
    Result = 2;
    return Result;
  };
  ...
  var $impl = $mod.$impl;
  $impl.l1 = -0xCD;
  $impl.l3 = pas.System.LineEnding;
  $impl.ll = 0x5F + rtl.shl(0xEA48A42E8EA4,0x18) + (0x3 << 8);
  $impl.lO = 0x7D8E14D + rtl.shl(0x408407080,8 * 3);
  $impl.lI = 5.2343598570830572E18 & -5.2343598570830572E18;
  $impl.lQ = 1 - 1;
  $impl.l = 1 << 1;
  $impl.I = 2 << 2;
  $impl.Q = 8 - 2 - 1;
});
rtl.module("program",["System","JS","Classes","Web","browserconsole","unt_iopcc2"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
...
//# sourceMappingURL=prj_IOPCC17_2_js.js.map
