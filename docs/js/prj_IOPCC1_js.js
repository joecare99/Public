...
rtl.module("Unt_iopcc",["System"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  this.Main = function () {
    var ll = rtl.arraySetLength(null,0,2049);
    var Hel = 0;
    var Wor = 8 - 8;
    var P = 0;
    var A = 0;
    ...
    var _C = 0;
    var oo = 0;
    var l1 = rtl.arraySetLength(null,0,4);
    $impl.E[0] = 8;
    CA = (39 * 39) - 1;
    A = CA;
    $impl.E[CA] = 2048 + 2;
    while ((Wor !== 0) || (_fe >= Hel)) {
      ...
      _C = $impl.E[S];
      Wor = 0;
      for (var $in1 = $impl.l0, $l2 = 0, $end3 = rtl.length($in1) - 1; $l2 <= $end3; $l2++) {
        P = $in1[$l2];
        A = $impl.lQ[P & 3] + S;
        if ((A >= 0) && (A < (39 * 39)) && (P !== (A % 39)) && ((_C & 2048) !== ($impl.E[A] & 2048))) {
          l1[$impl.H({get: function () {
              return Wor;
            }, set: function (v) {
              Wor = v;
            }})] = P;
      ...
      if (Wor !== 0) {
        P = l1[pas.System.Random(Wor)] & 3;
        A = $impl.lQ[P] + S;
        $impl.E[S] = _C | (1 << P);
        $impl.E[A] = $impl.E[A] | 2048 | (1 << ((P + 2) % 4));
        ll[$impl.H({get: function () {
            return _fe;
          }, set: function (v) {
            _fe = v;
          }})] = A;
      } else {
        if (_fe >= Hel) A = ll[$impl.H({get: function () {
            return Hel;
          }, set: function (v) {
            Hel = v;
          }})];
    ...
    $impl.Q(8 - 2);
    for (S = 1; S <= 38; S++) $impl.Q(8 >>> 1);
    $impl.Q(8 + 1);
    for (S = 1; S <= 39; S++) {
      for (A = 1; A <= 39; A++) $impl.Q($impl.E[$impl.H({get: function () {
          return oo;
        }, set: function (v) {
          oo = v;
        }})] & 6);
  ...
  $impl.l0 = [0,-3,39 - 1,-1];
  $impl.lQ = [1,39,-1,-39];
  $impl.E = rtl.arraySetLength(null,0,2049);
  $impl.H = function (Q) {
    var Result = 0;
    Result = Q.get();
    Q.set(Q.get() + 1);
  ...
  $impl.Q = function (U) {
    if (U < 8) {
      pas.System.Write($impl.C.charAt(((22907 >>> ($impl.H({get: function () {
          return U;
        }, set: function (v) {
          U = v;
        }}) << 1)) & 3) - 1) + $impl.C.charAt(((22907 >>> (U << 1)) & 3) - 1))}
     else pas.System.Write(pas.System.Copy($impl.C + $impl.C + $impl.C + pas.System.LineEnding,U + 1,3));
  };
});
rtl.module("program",["System","JS","Classes","Web","browserconsole","Unt_iopcc"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
...
//# sourceMappingURL=prj_IOPCC1_js.js.map
