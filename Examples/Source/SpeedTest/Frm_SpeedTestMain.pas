...
var
  FrmSpeedTestMain: TFrmSpeedTestMain;

implementation


constructor TFrmSpeedTestMain.Create(AOwner: TComponent);
var
  S: TFileStream;
begin
...
destructor TFrmSpeedTestMain.Destroy;
begin
  FPicture.Free;
  inherited Destroy;
end;

procedure TFrmSpeedTestMain.Paint;
var
  r: TRect;
begin
  inherited Paint;
...
procedure TFrmSpeedTestMain.ButtonClick(Sender: TObject);
begin
end;
