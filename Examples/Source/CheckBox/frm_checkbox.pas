...
uses
  Classes, Stdctrls, Forms, Buttons, Menus, Comctrls,
  SysUtils, ExtCtrls, GraphType, Graphics, Controls, LazLogger;

type
  TFrmCheckBoxMain = class(TForm)
  public
    Button2: TButton;
    Button3: TButton;
...
var
FrmCheckBoxMain : TFrmCheckBoxMain;
...
constructor TFrmCheckBoxMain.Create(AOwner: TComponent);
begin
...
procedure TFrmCheckBoxMain.Button1Click(Sender : TObject);
Begin
End;

procedure TFrmCheckBoxMain.Button2Click(Sender : TObject);
Begin
...
procedure TFrmCheckBoxMain.Button3Click(Sender : TObject);
var
   i : integer;
Begin
...
procedure TFrmCheckBoxMain.Button4Click(Sender : TObject);
Begin
End;

procedure TFrmCheckBoxMain.CheckBoxClick(Sender : TObject);
Begin
...
procedure TFrmCheckBoxMain.RadioButtonClick(Sender : TObject);
begin
...
procedure TFrmCheckBoxMain.RadioGroupClick(Sender : TObject);
begin
   debugln('[TForm1.RadioGroupClick]');
end;

procedure TFrmCheckBoxMain.ToggleBoxClick(Sender : TObject);
begin
...
procedure TFrmCheckBoxMain.FormKill(Sender : TObject);
Begin

End;

{------------------------------------------------------------------------------}
procedure TFrmCheckBoxMain.LoadMainMenu;
var
...
//   Button11.Caption:= 'Option 1';
   ...
   try
     BtnGlyph.LoadFromFile('../../examples/images/items/item_form.png');
...
{------------------------------------------------------------------------------}
procedure TFrmCheckBoxMain.mnuQuitClicked(Sender : TObject);
begin
  Close;
end;
{------------------------------------------------------------------------------}
