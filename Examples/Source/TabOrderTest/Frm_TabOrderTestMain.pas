...
type
  ...
  { TFrmTabOrderTestMain }

  TFrmTabOrderTestMain = class(TForm)
...
var
  FrmTabOrderTestMain: TFrmTabOrderTestMain;

implementation

{ TFrmTabOrderTestMain }

constructor TFrmTabOrderTestMain.Create(TheOwner: TComponent);
...
procedure TFrmTabOrderTestMain.CloseButtonClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmTabOrderTestMain.WriteTabOrder;
