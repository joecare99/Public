...
uses
  Classes, SysUtils,StdCtrls, Forms, Buttons, Menus, ComCtrls,
  Extctrls, Controls;

type
 TFrmComboboxMain = class(TFORM)
 public
   Label1: TLabel;
   Label2: TLabel;
   Label3: TLabel;
...
var
 FrmComboboxMain : TFrmComboboxMain;

implementation

constructor TFrmComboboxMain.Create(AOwner: TComponent);
begin
...
procedure TFrmComboboxMain.Button1Click(Sender : TObject);
Begin
  if assigned (ComboBox1) and assigned (edit1)
     then ComboBox1.Text := edit1.text;
End;

procedure TFrmComboboxMain.Button2Click(Sender : TObject);
Begin
...
procedure TFrmComboboxMain.Button3Click(Sender : TObject);
Begin
  if assigned (ComboBox1) and assigned (edit1)
     then edit1.Text := ComboBox1.Text;
End;

procedure TFrmComboboxMain.Button4Click(Sender : TObject);
Begin
  if assigned (ComboBox1)
     then ComboBox1.Enabled := not ComboBox1.Enabled;
End;

procedure TFrmComboboxMain.Button5Click(Sender : TObject);
var
  i : integer;
Begin
...
procedure TFrmComboboxMain.Button6Click(Sender : TObject);
var
  s : shortstring;
Begin
  if assigned (ComboBox1) then
...
procedure TFrmComboboxMain.Button7Click(Sender : TObject);
begin
 Edit1.SelectAll;
 ComboBox1.SelectAll;
end;
...
procedure TFrmComboboxMain.ComboOnChange (Sender:TObject);
var
  s : shortstring;
begin
  if sender is TEdit
...
procedure TFrmComboboxMain.ComboOnClick (Sender:TObject);
begin
  if assigned (Memo1)
...
procedure TFrmComboboxMain.FormKill(Sender : TObject);
Begin

End;

{------------------------------------------------------------------------------}
procedure TFrmComboboxMain.LoadMainMenu;
...
{------------------------------------------------------------------------------}
procedure TFrmComboboxMain.mnuQuitClicked(Sender : TObject);
begin
 Close;
end;
{------------------------------------------------------------------------------}
