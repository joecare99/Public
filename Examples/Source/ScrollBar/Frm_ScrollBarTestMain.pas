...
var
 FrmScrollBarTest : TFrmScrollBarTest;

implementation


constructor TFrmScrollBarTest.Create(AOwner: TComponent);
begin
...
procedure TFrmScrollBarTest.Button1Clicked(Sender : TObject);
begin
...
procedure TFrmScrollBarTest.Button2Clicked(Sender : TObject);
begin
  ScrollBar1.Min := ScrollBar1.Min + 20;
  LabelMin.Caption := IntToStr(ScrollBar1.Min);
end;

procedure TFrmScrollBarTest.Button3Clicked(Sender : TObject);
begin
  ScrollBar1.Max := ScrollBar1.Max + 25;
  LabelMax.Caption := IntToStr(ScrollBar1.Max);
end;

procedure TFrmScrollBarTest.Button4Clicked(Sender : TObject);
begin
  Scrollbar1.Position := ScrollBar1.Position + 5;
  LabelPos.Caption := IntToStr(ScrollBar1.Position);
end;

procedure TFrmScrollBarTest.Scrollbar1Changed(Sender : TObject);
begin
  LabelMin.Caption := IntToStr(Scrollbar1.Min);
  LabelMax.Caption := IntToStr(Scrollbar1.Max);
  LabelPos.Caption := IntToStr(Scrollbar1.Position);
...
procedure TFrmScrollBarTest.Scrollbar1OnScroll(Sender: TObject; ScrollCode: TScrollCode; var ScrollPos: Integer);
begin
  DebugLn('.............Scrolled...............');
end;
end.
