...
type
 TFrmSynEditTestMain = class(TForm)
   SynEdit1: TSynEdit;
 ...
 var
   FrmSynEditTestMain: TFrmSynEditTestMain;
implementation

{ TFrmSynEditTestMain }

procedure TFrmSynEditTestMain.Form1Resize(Sender: TObject);
begin
  with SynEdit1 do
    SetBounds(10,10,Parent.ClientWidth-10,Parent.ClientHeight-20);
end;

procedure TFrmSynEditTestMain.LoadDefaultText;
var
  E: String;
begin
  E:=#13#10;
...
procedure TFrmSynEditTestMain.LoadText(const Filename: string);
begin
  SynEdit1.Lines.LoadFromFile(Filename);
end;

constructor TFrmSynEditTestMain.Create(TheOwner: TComponent);
begin
...
destructor TFrmSynEditTestMain.Destroy;
begin
  inherited Destroy;
end;
