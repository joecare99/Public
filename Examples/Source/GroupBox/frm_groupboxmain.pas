...
var frmGroupBox : TFrmGroupBox;

implementation

constructor TFrmGroupBox.Create(AOwner: TComponent);
begin
...
procedure TFrmGroupBox.Button1Click(Sender : TObject);
Begin
 if assigned (grpTst) then grpTst.Height := grpTst.Height + 10;
End;

procedure TFrmGroupBox.Button2Click(Sender : TObject);
Begin
...
procedure TFrmGroupBox.Button3Click(Sender : TObject);
Begin
 if assigned (grpTst) then begin
   grpTst.Show;
 end;
...
procedure TFrmGroupBox.Button4Click(Sender : TObject);
Begin
 if assigned (grpTst) then begin
   grpTst.Hide;
 end;
...
{------------------------------------------------------------------------------}
procedure TFrmGroupBox.LoadMainMenu;
begin
...
{------------------------------------------------------------------------------}
procedure TFrmGroupBox.mnuQuitClicked(Sender : TObject);
begin
 Close;
end;
{------------------------------------------------------------------------------}
