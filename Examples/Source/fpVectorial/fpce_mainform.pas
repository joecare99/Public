...
begin
  ...
  try
    Reader.ExploreFromFile(shellInput.GetPathFromNode(shellInput.Selected), lChunk);

    labelFilename.Caption := 'Filename: ' + shellInput.GetPathFromNode(shellInput.Selected);
...
var
  lPath: String;
begin
  lPath := shellInput.GetPathFromNode(shellInput.Selected);// GetTextPath();
