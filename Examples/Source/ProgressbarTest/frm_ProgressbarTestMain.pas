...
type
  TFrmProgressbarTest = class(TFORM)
  public
...
var
  FrmProgressbarTest : TFrmProgressbarTest;


implementation


constructor TFrmProgressbarTest.Create(AOwner: TComponent);
begin
...
procedure TFrmProgressbarTest.Button1Click(Sender : TObject);
Begin
...
procedure TFrmProgressbarTest.Button2Click(Sender : TObject);
Begin
   if assigned (progre1) then begin
        Progre1.Position := 0;
   	progre1.Min := progre1.Min + 1;
...
procedure TFrmProgressbarTest.Button3Click(Sender : TObject);
Begin
   if assigned (progre1) then begin
	Progre1.Position := 0;
...
procedure TFrmProgressbarTest.Button4Click(Sender : TObject);
Begin
   if assigned (progre1) then begin
        Progre1.Position := 0;
	progre1.Max := progre1.Max -1;
...
procedure TFrmProgressbarTest.Button5Click(Sender : TObject);
Begin
   if assigned (progre1) then begin
...
procedure TFrmProgressbarTest.Button6Click(Sender : TObject);
Begin
   if assigned (progre1) then begin
...
procedure TFrmProgressbarTest.Button7Click(Sender : TObject);
Begin
...
procedure TFrmProgressbarTest.TimedOut(Sender : TObject);
Begin
   if assigned (progre1) then
   begin
      Progre1.StepIt;
...
{------------------------------------------------------------------------------}
procedure TFrmProgressbarTest.LoadMainMenu;
...
{------------------------------------------------------------------------------}
procedure TFrmProgressbarTest.mnuQuitClicked(Sender : TObject);
begin
  Close;
end;
{------------------------------------------------------------------------------}
