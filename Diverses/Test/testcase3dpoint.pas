...
procedure TTest3dPoint.TestDir3d15;
var
  i: integer;
  j: integer;
begin
...
procedure TTest3dPoint.TestDir3d22;
...
procedure TTest3dPoint.TestAdd;
var
  LTest: T3DPoint;
  i: integer;
begin
...
procedure TTest3dPoint.TestNeg;
var
  LTest: T3DPoint;
  LTest2: T3DPoint;
  og: longint;
...
begin
  ...
  try
    ...
    begin
      ...
      CheckEquals(0, Ltest.add(Dir3D22[i]).GLen, IntToStr(i) + ' v-v=0');
    end;
...
procedure TTest3dPoint.TestSmult;
begin
  // ToDo -oJC:
end;

procedure TTest3dPoint.TestGetDirNo;
var
  i: Integer;
begin
...
procedure TTest3dPoint.SetUp;
begin
  FZero := T3DPoint.init(nil);
end;

procedure TTest3dPoint.TearDown;
begin
  FZero.Free;
  FZero := nil;
end;
...
initialization
  ...
  RegisterTest('Test Point3D', TTest3dPoint{$IFNDEF FPC}.suite
{$ENDIF ~FPC}    );
end.
