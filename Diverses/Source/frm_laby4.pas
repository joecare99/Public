    ...
    begin
        if mark then
            PaintBox2.Canvas.Brush.Color :=
                rgb(63 + (FZValues[x, y] * 192) div (Clen * 2 + 5), 0 +
                (FZValues[x, y] * 192) div (Clen * 2 + 5), (FZValues[x, y] * 192) div (Clen * 2 + 5))
        else
            PaintBox2.Canvas.Brush.Color :=
                rgb((FZValues[x, y] * 196) div (Clen * 2 + 5), (FZValues[x, y] * 196) div
                (Clen * 2 + 5), (FZValues[x, y] * 255) div (Clen * 2 + 5));
        yy := clen - y - 1;
        xx := clen - x - 1;
