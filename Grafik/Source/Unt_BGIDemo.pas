...
begin { ReportStatus }
  ...
  WriteOut('Screen resolution  : (0, 0, ' + Int2Str(GetMaxX) + ', ' +
    Int2Str(GetMaxY) + ')');
  with ViewInfo do
    begin
  ...
  WriteOut('Current position   : (' + Int2Str(GetX) + ', ' +
    Int2Str(GetY) + ')');
...
begin
  ...
  repeat
    ...
    FillEllipse(Random(MaxX), Random(MaxY), Random(MaxRadius),
      Random(MaxRadius));
  until keypressed;
  WaitToGo;
end; { FillEllipsePlay }
...
begin
  ...
  OutTextXY(CenterX + 10 + X + TextWidth('H'),
    CenterY - AdjAsp(10 + Y), '25 %');
          ...
          if i <> Succ(NumBars) then
            begin
              ...
              Bar3D(J, round((y2 - y1 - H) - (BarHeight[i] * YStep)),
                round(J + XStep - Depth), round((y2 - y1) - H - 1),
                Depth, TopOn);
              J := round(J + XStep);
            end;
        end;
...
begin
  ...
  repeat
    ...
    Bar3D(Random(MaxWidth), Random(MaxHeight), Random(MaxWidth),
      Random(MaxHeight), 0, TopOff);
  until keypressed;
  WaitToGo;
end; { RandBarPlay }
...
begin
  ...
  repeat
    ...
    EndAngle := Random(360);
    SetLineStyle(SolidLn, 0, NormWidth);
    Arc(Random(MaxX), Random(MaxY), Random(EndAngle), EndAngle,
      Random(MaxRadius));
...
begin
  ...
  {$IFDEF FPC}
//  Saucer:=TBitmap.create;
  try
  {$ELSE}
  GetMem(Saucer, Size);
  {$ENDIF}
  GetImage(point(ulx, uly),point( lrx, lry), Saucer{$IFNDEF FPC}^{$endif});
  PutImage(point(ulx, uly), Saucer{$IFNDEF FPC}^{$endif}, XORPut); { erase image }
  ...
  repeat
    PutImage(point(X, Y), Saucer{$IFNDEF FPC}^{$endif}, XORPut); { draw image }
    Delay(Pausetime);
    PutImage(point(X, Y), Saucer{$IFNDEF FPC}^{$endif}, XORPut); { erase image }
...
const
  Patterns: array [0 .. 11] of FillPatternType = (($AA, $55, $AA, $55, $AA, $55,
    $AA, $55), ($33, $33, $CC, $CC, $33, $33, $CC, $CC),
    ($F0, $F0, $F0, $F0, $F, $F, $F, $F), (0, $10, $28, $44, $28, $10, 0, 0),
    (0, $70, $20, $27, $25, $27, $4, $4), (0, 0, 0, $18, $18, 0, 0, 0),
    (0, 0, $3C, $3C, $3C, $3C, 0, 0), (0, $7E, $7E, $7E, $7E, $7E, $7E, 0),
    (0, 0, $22, $8, 0, $22, $1C, 0), ($FF, $7E, $3C, $18, $18, $3C, $7E, $FF),
    (0, $10, $10, $7C, $10, $10, 0, 0), (0, $42, $24, $18, $18, $24, $42, 0));
var
  Style: word;
  Width: word;
  Height: word;
