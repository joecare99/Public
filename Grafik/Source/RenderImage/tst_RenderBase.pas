...
begin
 ...
 FFtupple.init(1.0,-1.0);
 CheckEquals(FTuple(3.0,-3.0),FFtupple.Subt(FTuple(2.0,-2.0)),1e-20,'init(1.0,-1.0).Subt(<2,-2>)');
 CheckEquals(1.0,FFtupple.v[0],format('init(%f,%f).v[0]',[1.0,-1.0]));
 CheckEquals(-1.0,FFtupple.v[1],format('init(%f,%f).v[1]',[1.0,-1.0]));
 FFtupple.init(23.0,17.0);
 CheckEquals(FTuple(26.0,14.0),FFtupple.Subt(FTuple(3.0,-3.0)),1e-20,'init(23.0,17.0).Subt(<-3,3)');
 CheckEquals(26.0,FFtupple.Subt(FTuple(3.0,-3.0)).v[0],format('init(%f,%f).v[0]',[23.0,17.0]));
 CheckEquals(14.0,FFtupple.Subt(FTuple(3.0,-3.0)).v[1],format('init(%f,%f).v[1]',[23.0,17.0]));
 for i := 0 to 50000 do
   begin
     x1:= (random-0.5)*maxLongint;
     y1:= (random-0.5)*maxLongint;
...
begin
 ...
 FFtupple.init(1.0,-1.0);
 CheckEquals(FTuple(3.0,-3.0),FFtupple.SubtTo(FTuple(2.0,-2.0)),1e-20,'init(1.0,-1.0).add(<2,-2>)');
 CheckEquals(3.0,FFtupple.x,format('init(%f,%f).v[0]',[1.0,-1.0]));
 CheckEquals(-3.0,FFtupple.y,format('init(%f,%f).v[1]',[1.0,-1.0]));
 FFtupple.init(23.0,17.0);
 CheckEquals(FTuple(26.0,14.0),FFtupple.SubtTo(FTuple(3.0,-3.0)),1e-20,'init(23.0,17.0).add(<-3,3)');
 CheckEquals(26.0,FFtupple.v[0],format('init(%f,%f).v[0]',[23.0,17.0]));
 CheckEquals(14.0,FFtupple.v[1],format('init(%f,%f).v[1]',[23.0,17.0]));
 for i := 0 to 50000 do
   begin
