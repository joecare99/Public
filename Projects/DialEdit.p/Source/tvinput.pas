...
type
    ...
    {   This variant of the Radio Buttons object
        ...
        { used to respond to mouse clicks and shortcut keys }
            Item: Sw_Integer   { index of selected button }
        ); virtual;
    end;
...
type
    ...
    TFilterValidator2 = object(TFilterValidator)
        ...
        function IsValidInput(var s: ShortString;
                {%H-}SuppressFill: boolean): boolean; virtual;
    end;

function TFilterValidator2.IsValid(const S: ShortString): boolean;
var
    I: integer;
begin
    I:= 1;
...
function TFilterValidator2.IsValidInput(var s: ShortString;
...
{ used to respond to up, down arrow keys: }
procedure TMRadioButtons.MovedTo(Item: Sw_Integer);
begin
...
{ used to respond to mouse clicks and shortcut keys: }
procedure TMRadioButtons.Press(Item: Sw_Integer);
begin
