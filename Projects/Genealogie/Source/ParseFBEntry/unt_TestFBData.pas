...
const
  cTestEntryGC5065=
    ...
    '● Kraft (Krafft), Karolina, ev. <Kraft, Georg Adam, Bürger, Bauer in '+
       ...
       '15.05.1896.'+lineEnding +
    'PN = 14598 '+lineEnding +
    '● Kinder: '+lineEnding +
    '1) August	* 06.08.1856 in Mörtelstein. † 11.04.1935 in Mörtelstein, Landwirt in Mörtelstein [5102]'+lineEnding +
    '2) Sophia	* 11.03.1859 in Mörtelstein. † 22.03.1938 in Mörtelstein [6757]'+lineEnding +
    '3) Anna Rosina	* 24.04.1861 in Mörtelstein. † 09.10.1899 in Guttenbach [6286]'+lineEnding +
    '4) Wilhelm	* 1863 in Mörtelstein.'+lineEnding ;

  cTestEntryAK2421=
    '2421	⚭ 28.12.1823: Andreas Rosewich <aus 2420>, Taglöhner, Tag­wächter,'+
        ' * 29.10.1796, † 6.4.1878,'+lineEnding +
    'u. Ursula Kobi <aus 1711>, * 19.7.1801, † 27.2.1859, 29 Jahre lang Hebamme.'+lineEnding +
...
const
  cResultTest:array[0..12] of TResultType =(
  ...
  // 73
   ...
   cResultEntryAK2421:array[0..54] of TResultType = (
    ...
    (eType:'ParserIndiOccu';Data:'Tag­wächter';Ref:'I2421M';SubType:7),
    (eType:'ParserIndiDate';Data:'29.10.1796';Ref:'I2421M';SubType:1),
{10}(eType:'ParserIndiDate';Data:'6.4.1878';Ref:'I2421M';SubType:4),
    ...
    (eType:'ParserIndiDate';Data:'19.7.1801';Ref:'I2421F';SubType:1),
...
{20}(eType:'ParserIndiData';Data:'M';Ref:'I2421C1';SubType:6),
  ...
  //  (eType:'ParserIndiDate';Data:'3.7.1824.';Ref:'I2421C1';SubType:4),
    ...
    (eType:'ParserFamilyIndiv';Data:'I2421C3';Ref:'2421';SubType:5),
    (eType:'ParserIndiData';Data:'M';Ref:'I2421C3';SubType:6),
{30}(eType:'ParserIndiDate';Data:'10.4.1828';Ref:'I2421C3';SubType:1),
    ...
    (eType:'ParserFamilyIndiv';Data:'I2421C5';Ref:'2421';SubType:7),
...
{40}(eType:'ParserIndiName';Data:'Ursula Rosewich';Ref:'I2421C6';SubType:0),
...
begin
  result:=format('(eType:%s;Data:%s;Ref:%s;SubType:%d)',[QuotedStr(eType),QuotedStr(Data),QuotedStr(Ref),SubType]);
end;
...
begin
  if (length(aValue) = 4)
    and TryStrToInt(aValue[3],SubType) then
    begin
      eType :=aValue[0];
      Data :=aValue[1];
      Ref :=aValue[2];
...
begin
  result := ''.Join(delim,[eType,Data,ref,inttostr(SubType)]);
end;
