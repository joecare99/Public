...
BEGIN
   StdFileMenuItems :=
     NewItem(rsNEw, '', kbNoKey, cmNew, hcNew,
     NewItem(rsOPen, 'F3', kbF3, cmOpen, hcOpen,
     NewItem(slSave, 'F2', kbF2, cmSave, hcSave,
     NewItem(slSaveAs, '', kbNoKey, cmSaveAs, hcSaveAs,
     NewItem(slSaveAll, '', kbNoKey, cmSaveAll, hcSaveAll,
     NewLine(
     NewItem(rsCHangeDir, '', kbNoKey, cmChangeDir, hcChangeDir,
     NewItem(rsOSShell, '', kbNoKey, cmDosShell, hcDosShell,
     NewItem(rsEXIt, 'Alt+X', kbAltX, cmQuit, hcExit,
     Next)))))))));
END;
