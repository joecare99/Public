...
procedure GetSystemEvent(out SystemEvent:TSystemEvent);
...
function PollSystemEvent(out SystemEvent: TSystemEvent):boolean;
...
begin
  if PendingSystemEvents<SystemEventBufSize then
   begin
     ...
     if {%H-}PtrUInt(PendingSystemTail)={%H-}PtrUInt(@PendingSystemEvent)+sizeof(PendingSystemEvent) then
