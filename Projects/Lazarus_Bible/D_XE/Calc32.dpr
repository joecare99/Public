...
Application.Initialize;
  ...
  Application.CreateForm(TfrmCalcAbout, Frm_CalcABOUT);
  Application.Run;
end.
  ...
  object edtEnterQuit: TEdit
    Left = 104
    Height = 21
    Hint = 'To exit enter ''quit'''
    Top = 64
    Width = 121
    OnChange = edtEnterQuitChange
    TabOrder = 0
  end
  object btnDemoQuit: TBitBtn
    ...
    Glyph.Data = {
      ...
      2000000000000004000064000000640000000000000000000000595D5B85686B
      ...
      F1FFF3F4F4FFF5F6F6FFF5F6F6FFECEEEDFF7D817FFFFFFFFF15595D5B855357
