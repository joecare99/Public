...
uses Forms,Frm_CALC64,Frm_CalcABOUT,StrUtils;

const MaxInt64= not (int64(1) shl 63);
...
procedure TTestCalc64.PunchIn(aValue: Int64);
  ...
  begin
    case aChar of
      ...
      '0'..'9','A'..'F':frmCalc64Main.ButtonDigitClick(frmCalc64Main.FindComponent('btn'+aChar))
    else
    end;
...
procedure TTestCalc64.PunchInKey(aValue: Int64);
  ...
  begin
    case aChar of
      '-',
      '0'..'9','A'..'F':frmCalc64Main.FormKeyPress(frmCalc64Main,aChar);
    else
    end;
    Application.ProcessMessages;
    Application.Idle(false);
...
begin
  ...
  for i := 0 to 50000 do
    begin
          if i mod 500 =0 then
      frmCalc64Main.Caption := 'Calc ['+DupeString('|',30-i*2 div 3333)+DupeString(' ',i*2 div 3333)+']';
      if random>0.5 then
...
begin
  ...
  for i := 0 to 1000 do
    begin
      frmCalc64Main.Caption := 'Calc ['+DupeString('|',30-i div 33)+DupeString(' ',i div 33)+']';
      if random>0.5 then
        lTestInt:= random(MaxInt64)
      else
        lTestInt:= -random(MaxInt64);
...
var
  ...
  begin
    ...
    frmCalc64Main.btnClearEntryClick(frmCalc64Main.btnClearEntry);
    CheckEquals('0000000000000000',frmCalc64Main.HexString,'Display: 0000000000000000');
    PunchIn($12345678);
    CheckEquals(inttohex($12345678,16),frmCalc64Main.HexString,'Display: $12345678');
    frmCalc64Main.btnClearEntryClick(frmCalc64Main.btnClearEntry);
    CheckEquals('0000000000000000',frmCalc64Main.HexString,'Display: 0000000000000000');
    PunchIn(int64($FEDCBA98));
    CheckEquals(inttohex($FEDCBA98,16) ,frmCalc64Main.HexString,'Display: -987654321');
    lOrgCaption:= frmCalc64Main.Caption;
    FSleeptime:=5;
    for i := 0 to 1000 do
      begin
      ...
      begin
        ...
        begin
          ...
          CheckEquals(inttohex(lTestInt shl 1,16) ,frmCalc64Main.HexString,
            'Display['+inttostr(i)+'].2p: $'+inttohex(lTestInt ,16)+' shl 1');
        end
      end;
    frmCalc64Main.Caption:=lOrgCaption;
end;
...
procedure TTestCalc64.TestOpAdd;
  ...
  begin
    ...
    CheckEquals(-987654321,frmCalc64Main.value-1234567890,'Checksum1: -987654321');
    CheckEquals(1234567890,frmCalc64Main.value+987654321,'Checksum2: 1234567890');
    CheckEquals(0,frmCalc64Main.value+987654321-1234567890,'FullInv: 0');
    lOrgCaption:= frmCalc64Main.Caption;
    for i := 0 to 10000 do
      begin
            if i mod 100 =0 then
        frmCalc64Main.Caption := 'Calc ['+DupeString('|',30-i div 333)+DupeString(' ',i div 333)+']';
        if random>0.5 then
          lTestInt:= random(MaxInt64)
        else
          lTestInt:= -random(MaxInt64);
        if random>0.5 then
          ...
          lTestInt2:= -random(MaxInt64);
        if (lTestInt<ltestInt2) and  (abs(lTestInt div 4 + ltestint2 div 4) > MaxInt64 div 4) then
          lTestInt2:=lTestInt2-lTestInt
        else if (lTestInt>ltestInt2) and  (abs(lTestInt div 4 + ltestint2 div 4) > MaxInt64 div 4) then
          lTestInt:=lTestInt-lTestInt2;
        lResult:=lTestInt+lTestInt2;
        frmCalc64Main.btnClearEntryClick(frmCalc64Main.btnClearEntry);
        CheckEquals('0',frmCalc64Main.DecString,'Display: 0');
        frmCalc64Main.Value := lTestInt;
        CheckEquals(lTestInt ,frmCalc64Main.Value,'Value['+inttostr(i)+'.1]: '+inttostr(lTestInt));
        frmCalc64Main.btnPlus.Click;
        CheckEquals(integer(opAdd) ,integer(frmCalc64Main.Operation),'Operation is Plus');
        frmCalc64Main.Value := lTestInt2;
        CheckEquals(lTestInt2 ,frmCalc64Main.Value,
           'Value['+inttostr(i)+'.2]: '+inttostr(lTestInt2));
        frmCalc64Main.btnEquals.Click;
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation ');
        CheckEquals(lResult ,frmCalc64Main.Value,
...
procedure TTestCalc64.TestOpSub;
  ...
  begin
    ...
    CheckEquals(-987654321,246913569-frmCalc64Main.value,'Checksum1: -987654321');
    CheckEquals(246913569,frmCalc64Main.value-987654321,'Checksum2: 1234567890');
    ...
    for i := 0 to 10000 do
      begin
        ...
        frmCalc64Main.btnMinus.Click;
        CheckEquals(integer(opSubtract) ,integer(frmCalc64Main.Operation),'Operation is Minus');
        frmCalc64Main.Value := lTestInt;
        CheckEquals(lTestInt ,frmCalc64Main.Value,
...
procedure TTestCalc64.TestOpMult;
  ...
  begin
    ...
    CheckEquals(integer(opMultiply) ,integer(frmCalc64Main.Operation),'Operation is Mult');
    CheckEquals(0,frmCalc64Main.value,'Display: 0');
    ...
    for i := 0 to 10000 do
      begin
        ...
        frmCalc64Main.Value := lTestInt;
        CheckEquals(lTestInt ,frmCalc64Main.Value,'Value['+inttostr(i)+'.1]: '+inttostr(lResult));
        frmCalc64Main.btnMultiply.Click;
        CheckEquals(integer(opMultiply) ,integer(frmCalc64Main.Operation),'Operation is Multiply');
        frmCalc64Main.Value := lTestInt2;
        CheckEquals(lTestInt2 ,frmCalc64Main.Value,'Value['+inttostr(i)+'.2]: '+inttostr(lTestInt2));
        frmCalc64Main.btnEquals.Click;
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation ');
        CheckEquals(lResult ,frmCalc64Main.Value,'Result['+inttostr(i)+']: '+inttostr(lResult));
        CheckEquals(lTestInt2 ,frmCalc64Main.Value div lTestInt,'Check['+inttostr(i)+'].1: '+inttostr(lTestInt2));
        CheckEquals(lTestInt ,frmCalc64Main.Value div lTestInt2,'Check['+inttostr(i)+'].2: '+inttostr(lTestInt));
        CheckEquals(1 ,frmCalc64Main.Value div lTestInt2 div lTestInt,'One['+inttostr(i)+']: 1');
...
procedure TTestCalc64.TestOpDiv;
  ...
  begin
    ...
    CheckEquals(integer(opDivide) ,integer(frmCalc64Main.Operation),'Operation is Divide');
    CheckEquals(0,frmCalc64Main.value,'Display: 0');
    frmCalc64Main.Value := 12345;
    Application.ProcessMessages;
    sleep(100);
    ...
    CheckEquals(-1219253925,frmCalc64Main.value * 12345,'Checksum1: -1219253925');
    ...
    for i := 0 to 10000 do
      begin
        ...
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation ');
        CheckEquals(lResult ,frmCalc64Main.Value,'Result['+inttostr(i)+']: '+inttostr(lResult));
        CheckEquals(lTestInt2 ,lTestInt div frmCalc64Main.Value  ,'Check['+inttostr(i)+'].1: '+inttostr(lTestInt2));
        CheckEquals(lTestInt ,frmCalc64Main.Value * lTestInt2,'Check['+inttostr(i)+'].2: '+inttostr(lTestInt));
        CheckEquals(1 ,lTestInt div lTestInt2 div frmCalc64Main.Value,'One['+inttostr(i)+']: 1');
  ...
  begin
    ...
    for i := 0 to 10000 do
      begin
        ...
        frmCalc64Main.Value := lTestInt;
        CheckEquals(lTestInt ,frmCalc64Main.Value,'Value['+inttostr(i)+']: '+inttostr(lTestInt));
        frmCalc64Main.btnNot.Click;
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation');
        CheckEquals(lResult ,frmCalc64Main.Value,'Result['+inttostr(i)+']: '+inttostr(lResult));
        frmCalc64Main.btnNot.Click;
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation');
        CheckEquals(lTestInt ,frmCalc64Main.Value,'Check['+inttostr(i)+']: '+inttostr(lTestInt));
...
procedure TTestCalc64.TestOpAnd;
  ...
  begin
    ...
    CheckEquals(integer(opAnd) ,integer(frmCalc64Main.Operation),'Operation is And');
    CheckEquals(0,frmCalc64Main.value,'Display: 0');
    frmCalc64Main.Value := -987654321;
    Application.ProcessMessages;
    sleep(100);
    ...
    CheckEquals(1090519618,1234567890 and frmCalc64Main.value,'Checksum1: 1090519618');
    CheckEquals(1090519618,-987654321 and frmCalc64Main.value,'Checksum1: 1090519618');
    ...
    for i := 0 to 10000 do
      begin
        ...
        frmCalc64Main.btnEquals.Click;
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation ');
        CheckEquals(lResult ,frmCalc64Main.Value,'Result['+inttostr(i)+']: '+inttostr(lTestInt2));
        CheckEquals(lResult ,frmCalc64Main.Value and lTestInt,'Check['+inttostr(i)+'].1: '+inttostr(lResult));
        CheckEquals(lResult ,frmCalc64Main.Value and lTestInt2,'Check['+inttostr(i)+'].2: '+inttostr(lResult));
        CheckEquals(0 ,frmCalc64Main.Value and not lTestInt,'Zero['+inttostr(i)+']: 0');
        CheckEquals(0 ,frmCalc64Main.Value and not lTestInt2,'Zero['+inttostr(i)+']: 0');
...
procedure TTestCalc64.TestOpOr;
  ...
  begin
    ...
    CheckEquals(integer(opOr) ,integer(frmCalc64Main.Operation),'Operation is Or');
    CheckEquals(0,frmCalc64Main.value,'Display: 0');
    frmCalc64Main.Value := -987654321;
    Application.ProcessMessages;
    sleep(100);
    ...
    CheckEquals(-843606049,1234567890 Or frmCalc64Main.value,'Checksum1: -843606049');
    CheckEquals(-843606049,-987654321 Or frmCalc64Main.value,'Checksum1: -843606049');
    ...
    for i := 0 to 10000 do
      begin
        ...
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation ');
        CheckEquals(lResult ,frmCalc64Main.Value,'Result['+inttostr(i)+']: '+inttostr(lTestInt2));
        CheckEquals(lResult ,frmCalc64Main.Value Or lTestInt,'Check['+inttostr(i)+'].1: '+inttostr(lResult));
        CheckEquals(lResult ,frmCalc64Main.Value Or lTestInt2,'Check['+inttostr(i)+'].2: '+inttostr(lResult));
        CheckEquals(-1 ,frmCalc64Main.Value Or not lTestInt,'Full['+inttostr(i)+']: -1');
        CheckEquals(-1 ,frmCalc64Main.Value Or not lTestInt2,'Full['+inttostr(i)+']: -1');
...
procedure TTestCalc64.TestOpXor;
  ...
  begin
    ...
    CheckEquals(integer(opXor) ,integer(frmCalc64Main.Operation),'Operation is Xor');
    CheckEquals(0,frmCalc64Main.value,'Display: 0');
    frmCalc64Main.Value := -987654321;
    Application.ProcessMessages;
    sleep(100);
    ...
    CheckEquals(-987654321,1234567890 Xor frmCalc64Main.value,'Checksum1: -987654321');
    CheckEquals(1234567890,-987654321 Xor frmCalc64Main.value,'Checksum1: 1234567890');
    ...
    for i := 0 to 10000 do
      begin
        ...
        CheckEquals(integer(opNo) ,integer(frmCalc64Main.Operation),'No Operation ');
        CheckEquals(lResult ,frmCalc64Main.Value,'Result['+inttostr(i)+']: '+inttostr(lTestInt2));
        CheckEquals(lTestInt2 ,frmCalc64Main.Value Xor lTestInt,'Check['+inttostr(i)+'].1: '+inttostr(lTestInt2));
        CheckEquals(lTestInt ,frmCalc64Main.Value Xor lTestInt2,'Check['+inttostr(i)+'].2: '+inttostr(lTestInt));
        CheckEquals(0 ,frmCalc64Main.Value Xor lTestInt Xor  lTestInt2,'Zero['+inttostr(i)+']: 0');
...
begin
  ...
  begin
        ...
        if fIdleCnt> 300 then
          ...
          frmCalc64Main.Caption := 'Calc ['+DupeString('|',30-fIdleCnt div 10)+DupeString(' ',fIdleCnt div 10)+']';
     end;
  frmCalc64Main.Caption:=lOrgCaption;
end;
